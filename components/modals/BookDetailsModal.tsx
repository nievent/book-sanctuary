...
import { X, Trash2, Edit, Star, Calendar } from "lucide-react"
    ...
    <>
              ...
              <div>
                ...
                {book.rating && (
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-sm font-medium text-ink-600 ml-2">
                  ...
                  <div className="space-y-3">
                    {book.started_at && (
                      <div className="flex items-center gap-2 text-sm">
                        ...
                        <span className="text-ink-500">Iniciado:</span>
                    ...
                    {book.completed_at && (
                      <div className="flex items-center gap-2 text-sm">
                        ...
                        <span className="text-ink-500">Terminado:</span>
                        <span className="text-ink-900 font-medium">
      ...
      <EditBookModal
        ...
        onClose={() => {
          ...
          onClose() // Cerrar también el modal de detalles después de editar
        }}
      />
    </>
  )
